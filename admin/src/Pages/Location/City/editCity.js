...
export default function EditCity() {
    ...
    const loadCity = async() => {
        const resCity = await Axios.get(`http://admin-tch.herokuapp.com/api/admin/getIdCity?id=${id}`) // Gọi Api getIdCity + id để lấy Danh sách Thành phố
        const resCountry = await Axios.get(`http://admin-tch.herokuapp.com/api/admin/getListCountry`) //  Gọi Api getListCountry để lấy Danh sách Quốc gia cho <select>
